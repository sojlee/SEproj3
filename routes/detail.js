...
router.post('/write_review', function(req, res, next) {
	...
	console.log(product_code + ", " + user + ", " + content + ", " + score);

	pool.getConnection(function (err, connection) {
	// review 테이블에 insert한다.
	var insertReview = "insert into review(product_code, user, content, score) values(?,?,?,?)";
        connection.query(insertReview, function (err, rows) {
